...
const Footer = () => {
    return (
        <footer className="px-4 divide-y dark:bg-coolGray-800 dark:text-coolGray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link to='/' className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Pickr Delivery</span>
                    </Link>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <Link rel="noopener noreferrer" to="/delivery_info">Delivery Information</Link>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Suppliers</a>
                            </li>
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase dark:text-coolGray-50">Get App</h3>
                        <ul className="space-y-1">
                            <li>
                                <a href="https://play.google.com/store/apps/details?id=com.pickr.io">
                                    <img src="https://www.freshdirect.com/assets/fdfw/images/social/google-store.svg" className='w-[80%] object-contain' />
                                </a>
                            </li>
            ...
            <div className="py-6 text-sm text-center dark:text-coolGray-400">© 2019 Pickr Co. All rights reserved.</div>
        </footer>
    )
}
